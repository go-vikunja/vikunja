...
const expectedFormats = {
  ...
  [DATE_DISPLAY.DAY_MONTH_YEAR]: new Intl.DateTimeFormat('en', {day: 'numeric', month: 'long', year: 'numeric'}).format(createdDate),
  [DATE_DISPLAY.WEEKDAY_DAY_MONTH_YEAR]: new Intl.DateTimeFormat('en', {weekday: 'long', day: 'numeric', month: 'long', year: 'numeric'}).format(createdDate),
}
