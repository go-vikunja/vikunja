...
const clients = computed(() => [
	{id: 'claudeCode', name: 'Claude Code', helpUrl: 'https://code.claude.com/docs/en/mcp'},
	{id: 'codex', name: 'Codex', helpUrl: 'https://learn.chatgpt.com/docs/extend/mcp?surface=cli'},
	{id: 'claudeDesktop', name: 'Claude Desktop / claude.ai', helpUrl: 'https://claude.com/docs/connectors/custom/remote-mcp'},
	{id: 'mistral', name: 'Mistral Vibe', helpUrl: 'https://docs.mistral.ai/vibe/work/connectors/mcp-connectors'},
	{id: 'chatgpt', name: 'ChatGPT', helpUrl: 'https://developers.openai.com/api/docs/guides/developer-mode'},
	{id: 'other', name: t('user.settings.mcp.clients.other.title'), helpUrl: MCP_HELP},
])
const selectedClient = computed(() => clients.value.find(({id}) => id === client.value))
...
<template>
	<div class="mcp-client-guide">
		...
		<p v-if="selectedClient">
			<a
				:href="selectedClient.helpUrl"
				target="_blank"
				rel="noreferrer"
			>{{ client === 'other' ? t('user.settings.mcp.more') : t('user.settings.mcp.clientHelp', {client: selectedClient.name}) }}</a>
		</p>
	</div>
</template>
