// Code generated by 'yaegi extract github.com/labstack/echo/v5'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/labstack/echo/v5/echo"] = map[string]reflect.Value{
		...
		"LegacyIPExtractor":                     reflect.ValueOf(echo.LegacyIPExtractor),
		...
		"NewDefaultFS":                          reflect.ValueOf(echo.NewDefaultFS),
		...
		"QUERY":                                 reflect.ValueOf(constant.MakeFromLiteral("\"QUERY\"", token.STRING, 0)),
		...
		"ResolveResponseStatus":                 reflect.ValueOf(echo.ResolveResponseStatus),
		...
		"StatusCode":                            reflect.ValueOf(echo.StatusCode),
		...
		"Version":                               reflect.ValueOf(constant.MakeFromLiteral("\"5.3.1\"", token.STRING, 0)),
