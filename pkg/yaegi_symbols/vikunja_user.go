...
func init() {
	Symbols["code.vikunja.io/api/pkg/user/user"] = map[string]reflect.Value{
		...
		"ErrCodeUsernameMustNotStartWithAt":    reflect.ValueOf(constant.MakeFromLiteral("1039", token.INT, 0)),
		...
		"IsErrUsernameMustNotStartWithAt":      reflect.ValueOf(user.IsErrUsernameMustNotStartWithAt),
		...
		"ErrUsernameMustNotStartWithAt":                     reflect.ValueOf((*user.ErrUsernameMustNotStartWithAt)(nil)),
