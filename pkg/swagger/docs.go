        ...
        "/subscriptions/{entity}/{entityID}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The entity the user subscribes to. Can be either ` + "`" + `namespace` + "`" + `, ` + "`" + `project` + "`" + ` or ` + "`" + `task` + "`" + `.",
                        "name": "entity",
                        "in": "path",
                        "required": true
                    },
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The entity the user subscribed to. Can be either ` + "`" + `namespace` + "`" + `, ` + "`" + `project` + "`" + ` or ` + "`" + `task` + "`" + `.",
                        "name": "entity",
                        "in": "path",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "models.Project": {
            ...
            "properties": {
                ...
                "is_favorite": {
                    "description": "True if a project is a favorite. Favorite projects show up in a separate namespace. This value depends on the user making the call to the api.",
                    "type": "boolean"
                },
                "namespace_id": {
                    "type": "integer"
        ...
        "models.SavedFilter": {
            ...
            "properties": {
                ...
                "is_favorite": {
                    "description": "True if the filter is a favorite. Favorite filters show up in a separate namespace together with favorite projects.",
                    "type": "boolean"
                },
                "owner": {
