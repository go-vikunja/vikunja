    ...
    "paths": {
        ...
        "/migration/deck/auth": {
            "get": {
                ...
                "description": "Returns empty as authentication is done via credentials in the migration request",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Get auth instructions for Nextcloud Deck",
                "responses": {
                    "200": {
                        "description": "The auth instructions",
                        "schema": {
        ...
        "/migration/deck/migrate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Nextcloud server credentials",
                        "name": "migrationData",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/deck.Migration"
                        }
                    }
                ],
                "responses": {
