...
func TestTaskCollection_ReadAll(t *testing.T) {
	...
	*task1WithReaction = *task1
	...
	tests := []testcase{
		...
		{
			name: "filter bucket equals",
			fields: fields{
				Filter: "bucket = 'testbucket1'",
			},
			args: defaultArgs,
			want: []*Task{
				task1,
		...
		{
			name: "filter bucket in multiple",
			fields: fields{
				Filter: "bucket in 'testbucket1', 'testbucket2'",
			},
			args: defaultArgs,
			want: []*Task{
				task1,
		...
		{
			name: "filter bucket not in",
			fields: fields{
				Filter: "bucket not in 'testbucket1', 'testbucket2'",
			},
			args: defaultArgs,
			want: []*Task{
				task2,
		...
		{
			name: "filter bucket like pattern",
			fields: fields{
				Filter: "bucket like 'testbucket%'",
			},
			args: defaultArgs,
			want: []*Task{
				task1,
