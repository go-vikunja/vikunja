...
type ProjectView struct {
	...
	IncludeSubprojects bool `xorm:"default false not null" json:"include_subprojects" doc:"If enabled, this view also includes tasks from all descendant subprojects."`
