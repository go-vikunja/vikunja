...
func TestGetAvatarForUser_HandlesInvalidCachedType(t *testing.T) {
	// Initialize storage for testing
	keyvalue.InitStorage()
...
func TestGetAvatarForUser_HandlesValidCachedType(t *testing.T) {
	// Initialize storage for testing
	keyvalue.InitStorage()
...
func TestGetAvatar_GeneratesValidInitials(t *testing.T) {
	// Initialize storage for testing
	keyvalue.InitStorage()
