...
type TaskListQueryParams struct {
	...
	IncludeSubprojects bool     `query:"include_subprojects" doc:"If true, also returns tasks from all descendant subprojects the user can access. Ignored outside a concrete project and for link shares."`
